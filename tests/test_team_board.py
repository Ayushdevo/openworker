...
def test_tool_sets_are_role_filtered(store):
    ...
    assert lead_names == {"create_item", "list_items", "get_item", "transition", "comment", "assign", "link"}
    assert worker_names == {"create_item", "list_items", "get_item", "transition", "comment", "claim", "set_status"}
